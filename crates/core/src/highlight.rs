...
//! hikari-core itself is egui-free (pure, fleet-portable); this thin adapter —
...
pub fn layout_job(
    ...
    // Defensive: if a highlighter yielded nothing for non-empty text, show it
    // plain rather than blank (builtins always cover).
