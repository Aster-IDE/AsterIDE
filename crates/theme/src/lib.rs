...
pub use themes::{CherryBlossomDark, CherryBlossomLight, RosePine, RosePineMoon, RosePineDawn, DraculaDark, NordDark, GruvboxDark, GruvboxLight, CatppuccinFrappé, CatppuccinLatte, CatppuccinMacchiato, CatppuccinMocha};
...
impl ThemeVariant {
    ...
    pub fn apply(&self, ctx: &egui::Context, corner_roundness: f32) {
        match self {
            ThemeVariant::CherryBlossomDark => themes::CherryBlossomDark::apply(ctx, corner_roundness),
            ThemeVariant::CherryBlossomLight => themes::CherryBlossomLight::apply(ctx, corner_roundness),
            ...
            ThemeVariant::CatppuccinFrappé => themes::CatppuccinFrappé::apply(ctx, corner_roundness),
            ThemeVariant::CatppuccinLatte => themes::CatppuccinLatte::apply(ctx, corner_roundness),
            ThemeVariant::CatppuccinMacchiato => themes::CatppuccinMacchiato::apply(ctx, corner_roundness),
...
impl ThemeManager {
    ...
    pub fn set_variant(&mut self, variant: ThemeVariant) {
        ...
        self.current_family = match variant {
            ...
            ThemeVariant::CatppuccinFrappé | ThemeVariant::CatppuccinLatte | ThemeVariant::CatppuccinMacchiato | ThemeVariant::CatppuccinMocha => ThemeFamily::Catppuccin,
        };
    }
